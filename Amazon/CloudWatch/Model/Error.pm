...
package Amazon::CloudWatch::Model::Error;
...
use base qw (Amazon::CloudWatch::Model);
    ...
    # Code: string
    # Message: string
    # Detail: Amazon::CloudWatch::Model::Object
    #
    # 
    # 
    sub new {
        ...
        $self->{_fields} = {
            ...
            Detail => {FieldValue => undef, FieldType => "Amazon::CloudWatch::Model::Object"},
        };
